...
const Water = () => {
  return (
    <Stack.Navigator>
      ...
      />
      <Stack.Screen
        name="WaterSaverComments"
        component={WaterComments}
        options={{title: ''}}
      />
    </Stack.Navigator>
  );
...
const Food = () => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        name="UpdateFoodTip"
        component={UpdateFoodTip}
        options={{title: ''}}
      />
      <Stack.Screen
        name="ViewTipsOneByOne"
        component={FoodTipViewOneByOne}
        options={{title: ''}}
      />
    </Stack.Navigator>
  );
...
const App = () => {
  return (
    <>
      <NavigationContainer>
        <Bottom.Navigator initialRouteName="MainHome">
          <Bottom.Screen
            name="Electricity"
            ...
            options={{
              ...
              tabBarIcon: ({focused}) => (
                <View>
                  <Image
                    source={require('./src/navigation/electricIcon.png')}
          ...
          <Bottom.Screen
            ...
            options={{
              ...
              tabBarIcon: ({focused}) => (
                <View>
                  <Image
                    source={require('./src/navigation/waterIcon.png')}
          ...
          <Bottom.Screen
            ...
            options={{
              ...
              tabBarIcon: ({focused}) => (
                <View>
                  <Image
                    source={require('./src/navigation/homeIcon.png')}
          ...
          <Bottom.Screen
            ...
            options={{
              ...
              tabBarIcon: ({focused}) => (
                <View>
                  <Image
                    source={require('./src/navigation/fuelIcon.png')}
          ...
          <Bottom.Screen
            ...
            options={{
              ...
              tabBarIcon: ({focused}) => (
                <View>
                  <Image
                    source={require('./src/navigation/foodIcon.png')}
